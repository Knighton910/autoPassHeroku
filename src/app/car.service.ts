...
const CARS = [
  new Car(
    ...
    '185 MPH',
    '180,452',
    'In true Mercedes-Benz fashion, the SLS is a crowd pleaser that makes no compromises.\n' +
    '\n' +
  ...
  new Car(
    ...
    '150 MPH',
    '90,000',
    'Worth a special mention is the Cadillac escalade for rent. Even if you are not an automobile buff, it is a well known fact that Cadillac escalade is a grand and luxurious SUV manufactured by General Motors. It made the debuted as the 1st Cadillac in the popular SUV market. Even though it is a huge vehicle, it still is one of the most elegant and efficient automobile that is available in the market. When in wonder as to which car to rent, rent Cadillac Escalade ESV. Come race with us, rally around the world, experience wondrous culinary feats in our new, member-only restaurant or soak up the sun and sangria on our beautiful river terrace. This is a new level of membership. Easy access',
    'MSRP: $90,000',
    'Transmission: Auto',
    'Horsepower: 240',
    'Interior: Grey',
  ...
  new Car(
    ...
    '205 MPH',
    'PRICELESS',
    'Almost all of the popular car rental companies now offer a suite of exotic cars and luxury cars in their fleet.  This has made it possible for you to rent a Batmobile at any number of rent-a-car company’s nationwide locations.  AVA Auto Club however, stands out as the premier provider of luxury and exotic cars for rent.  With their impressive fleet of exclusive high-end vehicles which includes the Land Rover Sport, the BMW and the Maserati, you can rent the Batmobile in the color that fits your personality.  They have a strategic presence in in more than seven locations nationwide. Rent Batmobile today!',
    'MSRP: PRICELESS',
    'Transmission: Auto',
    'Horsepower: 360',
    'Interior: Black',
